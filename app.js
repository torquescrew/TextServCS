...
var app, buff, express, fs, http, io, openFile, openFolder, path, pty, routes, server, socket, stream, term, terminal, u, user, wd;
...
server.on("connection", function(socket) {
  ...
  if (address !== "127.0.0.1" && address !== "::1") {
    ...
    return console.log("Attempted connection from %s. Refused.", address);
  }
});
